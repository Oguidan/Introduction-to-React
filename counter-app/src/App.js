  ...
  return (
    <div className='App'>
      <div className='innerContainer'>
        <h1>Counter App</h1>
        <p style={{textAlign:"center"}}>This is a counter application built by Archangel Michael, powered by React</p>
        ...
        <p>By increments</p>
        <input type="input" value={counterIncrements} onChange={(e)=>
        ...
        <div className='buttonCountainer'>
          ...
          <div className='buttonContainer'>
          <button onClick={()=>{setMaxium(minimum-1)}}>-</button>
          <button onClick={()=>{setMaxium(minimum+1)}}>+</button>
          </div>
